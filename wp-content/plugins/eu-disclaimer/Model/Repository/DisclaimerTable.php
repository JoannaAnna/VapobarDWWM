...
class DisclaimerTable {
    ...
    static function displayDisclaimerModal () {
        ...
        <div id="myModal" class="modal">
            <p>La vente de Cigarettes électroniques est interdite aux personnes mineures 
                et n\'est pas recommandée aux femmes enceintes ou qui allaitent. De plus, 
                en cas de pathologie particulières (maladies cardio-vasculaires, asthme, 
                épilepsie...), Vapostore vous recommande d\'en parler avec votre médecin 
                traitant avant utilisation.</p>
