...
function createCookie(name, value, duration) {
    ...
    if(duration) {
        ...
        var expire = "";   // Si aucune valeur de jour n'est spécifiée le cookie expire à la fin de la session 
    }
    // console.log("test :", date); // On vérifie la date
...
function readCookie(name) {
    ...
    for(var i=0; i<tCookies.length; i++) {
        ...
        // si le cookie a un espace, on le soustrait (l'espace au debut)
